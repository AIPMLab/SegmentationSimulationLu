...
#     #
#     # if download_pretrained and not os.path.isfile('./weights/swin_tiny_patch4_window7_224.pth'):
#     #     print('Downloading Swin-transformer model ...')
...
#     # cfg.swin_pretrained_path = './weights/swin_tiny_patch4_window7_224.pth' if download_pretrained else None
...
def get_hiformer_b_configs():
    ...
    cfg.num_classes = 2
    cfg.swin_pretrained_path = None
    # cfg.swin_pretrained_path = r'.\weights\swin_tiny_patch4_window7_224.pth'
    cfg.window_size = 7
